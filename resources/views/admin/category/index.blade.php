					...
					<div class="col-12">
						<div class="card">
							<div class="card-header d-flex">
								...
								<div class="ml-auto">
									<a class="btn btn-primary text-decoration-none" href="{{ route('category.create') }}">
										Add Category
									</a>
								</div>
							</div>
								...
								<table id="dataTable" class="table table-bordered table-striped">
									...
									<tbody>
										...
										<tr>
											...
											{{--<td class="d-flex">
												<a href="{{ route('category.edit',['category' =>  $value->id  ]) }}" class="text-decoration-none px-1"><i class="fas fa-edit"></i></a>
												
												<form action="{{ route('category.destroy',['category' => $value->id ]) }}" method="POST" id="deleteForm{{ $value->id }}">
												    @csrf
												    @method('DELETE')
